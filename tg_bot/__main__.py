...
TECHNO_IMG = "https://telegra.ph/file/f826876422de0ef7d03d5.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/hacker11000")],
                                                                                   [InlineKeyboardButton(text="ADD Krrish TO YOUR GROUP",
        ...
        update.effective_message.reply_text("Boss, I am on duty😎")
