            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       callback_data="help_back".format(bot.username)),
                                                                                   InlineKeyboardButton(text= MY HERO AND CREATER",
                                                                       url="t.me/dhanush321")],
                                                                                   [InlineKeyboardButton(text="ADD SECURITY GUARD TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   

    else:
        update.effective_message.reply_text("Yuss, WHEN GROUP WILL DELETE THEN I WILL BE OFFLINE IN YOUR GROUP")
