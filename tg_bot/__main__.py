...
TECHNO_IMG = "https://telegra.ph/file/ad3715969768db2754d53.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/Alpha_402")],
                                                                                   [InlineKeyboardButton(text="ADD ULTRA MANAGER TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Source Code",
                                                                       url="https://github.com/Techno212/GRANDROBOT")
                                                                                 ]]))

    else:
        update.effective_message.reply_text("⚜️ ZINDA HU BHAI 😁⚡ ⚜️")
