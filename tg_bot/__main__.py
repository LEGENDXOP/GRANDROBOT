...
TECHNO_IMG = "https://telegra.ph/file/42b916b092d1190a2d4ab.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="HELP",
                                                                       ...
                                                                       url="t.me/Kakashi_hatake_001")],
                                                                                   [InlineKeyboardButton(text="ADD pakkun bot TO YOUR GROUP",
        ...
        update.effective_message.reply_text("sumning jugsu se jinda hota hu,aab hogya hu Zinda")
