...
{}
And the following:
""".format(dispatcher.bot.☣️yakari☣️, "" if not ALLOW_EXCL else "\nAll commands can either be used with / or !.\n")
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="😎 help command 😎",
                                                                       callback_data="help_back".format(bot.username)),
                                                                                   InlineKeyboardButton(text="🇱🇰join our group🇱🇰 ",
                                                                       url="t.me/@supunmasl")],
                                                                                   [InlineKeyboardButton(text="👋let me manage your group 👍",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="👺my creater👺",
                                                                       url="t.me/@supunma")
                                                                                 ]]))
